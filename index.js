...
function get20s(array) {
  for (i = 0; i < array.length; i++) {
    if (Number(array[i].years.slice(0, 5)) <= 2000 && (Number(array[i].years.slice(0, 5)) >= 1900)) {
...
function addArtist(arrayAdding, id, name, years, genre, nationality, bio) {
